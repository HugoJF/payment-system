...
@section('content')
    <div class="flex flex-col p-4 justify-center items-center sm:p-6">
        ...
        <p class="flex mt-8 pb-4 justify-center items-baseline text-center text-5xl">
            ...
            <span class="text-grey-darkest font-semibold">12,00</span>
        </p>
    
        <div class="my-2 w-16 h-16 fill-current text-red-dark">
            @include('icons.cross')
        </div>
    
        <a href="{{ $order->return_url }}" class="mt-4 py-4 px-12 text-grey-darker text-xl font-normal no-underline hover:text-grey-darkest hover:underline">‹ Voltar</a>
    </div>
@endsection